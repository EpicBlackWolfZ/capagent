...
| [M2 — Host Facts](https://github.com/EpicBlackWolfZ/capagent/milestone/3) | Host topology and security implemented | Passive host report, syscall adapters and fixture/native validation; cgroups, namespaces and security delivered; network/filesystem prerequisites follow. |
