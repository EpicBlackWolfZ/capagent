...
| [M2 — Host Facts](https://github.com/EpicBlackWolfZ/capagent/milestone/3) | Host topology and security implemented | Current credential and namespace observations; broader host probes remain queued. |
