...
| [M2 — Host Facts](https://github.com/EpicBlackWolfZ/capagent/milestone/3) | OS/kernel/systemd slice implemented | Current credential and namespace observations; broader host probes remain queued. |
